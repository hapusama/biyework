...
# class WrappedPixelDiffusion(pl.LightningModule):
#     def __init__(self, input_dim, output_dim, *args, **kwargs):
#         super(WrappedPixelDiffusion, self).__init__()
#         self.linear = torch.nn.Linear(input_dim, output_dim)
#         self.pixel_diffusion = PixelDiffusionConditional_v2(*args, **kwargs)

#     def forward(self, x, *args, **kwargs):
#         x = self.linear(x)
#         x = x.view(x.size(0), -1, self.pixel_diffusion.input_dim)
#         return self.pixel_diffusion(x, *args, **kwargs)

#     def training_step(self, batch_data, batch_idx):
#         return self.pixel_diffusion.training_step(batch_data, batch_idx)

#     def validation_step(self, batch_data, batch_idx):
#         return self.pixel_diffusion.validation_step(batch_data, batch_idx)

#     def configure_optimizers(self):
#         return self.pixel_diffusion.configure_optimizers()
...
#         dirpath=output_dir, 
#         filename="model_path_pretrain_rgm",  # seems does not used
#         monitor="val_loss",
#         mode="min",
#         save_top_k=1,
#         verbose=True)

#     model = WrappedPixelDiffusion(input_dim, output_dim=2*16, 
